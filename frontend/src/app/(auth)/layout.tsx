        ...
        <div className="relative z-10 max-w-xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
              ...
              <span className="text-xs font-medium text-primary">Uncertainty-Aware Clinical Triage</span>
            </div>
            ...
            <h1 className="text-5xl font-bold tracking-tight leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-400 to-cyan-400">
                Dermoscopic Skin Cancer Detection
              </span>
            </h1>
            
            <p className="text-lg text-slate-400 leading-relaxed">
              Multimodal deep learning combining dermoscopic imaging with patient metadata — delivering ACCEPT, DEFER, or REJECT decisions with a formal 90% statistical coverage guarantee.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <div className="group p-5 rounded-xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/60 hover:border-primary/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-white">Late-Fusion Multimodal</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed">
                ConvNeXt-Tiny visual encoder fused with age, sex, and anatomical site metadata
              </p>
            </div>
            ...
            <div className="group p-5 rounded-xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/60 hover:border-primary/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-white">Conformal Prediction</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed">
                Distribution-free safety gate with guaranteed 90% class coverage
              </p>
            </div>
            ...
            <div className="group p-5 rounded-xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/60 hover:border-primary/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/10 col-span-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-white">Grad-CAM++ Explainability</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed">
                Every ACCEPT decision includes a saliency heatmap overlay so clinicians can verify exactly what the model attended to before acting
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-6 border-t border-slate-800">
            <div>
              <div className="text-2xl font-bold text-white">82.97%</div>
              <div className="text-xs text-slate-500">Balanced Accuracy</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-white">85.86%</div>
              <div className="text-xs text-slate-500">Melanoma Recall</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-white">≥ 90%</div>
              <div className="text-xs text-slate-500">Coverage Guarantee</div>
            </div>
          </div>
        </div>
      </div>
